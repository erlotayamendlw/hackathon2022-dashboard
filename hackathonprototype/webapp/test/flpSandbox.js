		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sci Valley Dashboard",
									"targetURL": "#hackathonprototype-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"hackathonprototype-display": {
								"semanticObject": "hackathonprototype",
								"action": "display",
								"description": "A Fiori application for the hackathon.",
								"title": "Sci Valley Dashboard",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hackathonprototype",
									"url": sap.ui.require.toUrl("hackathonprototype")
								}
							}
						}
					}
